...
@Entity
@Table(name = "core.CL_MAZAK_011")
public class CL_MAZAK_011 {
    @Id
    ...
    public String getPART_COUNT_ACT() {
        return PART_COUNT_ACT;
    }

    public void setPART_COUNT_ACT(String PART_COUNT_ACT) {
    ...
    public void setXABS(String XABS) {
        this.XABS = XABS;
    }
    ...
    public void setXFRT(String XFRT) {
        this.XFRT = XFRT;
    }

    public String getXLOAD() {
        return XLOAD;
    }
