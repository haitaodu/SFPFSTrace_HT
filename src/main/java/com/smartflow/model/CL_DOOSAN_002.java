...
@Entity
@Table(name = "core.CL_DOOSAN_002")
public class CL_DOOSAN_002 {
    @Id
    ...
    public String getIS_RUN1() {
        return IS_RUN1;
    }

    public void setIS_RUN1(String IS_RUN1) {
        this.IS_RUN1 = IS_RUN1;
    }
