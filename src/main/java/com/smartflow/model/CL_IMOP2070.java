...
@Entity
@Table(name = "CL_IMOP2070", schema = "core", catalog = "MESDB_SXHTDL")
public class CL_IMOP2070 {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        CL_IMOP2070 that = (CL_IMOP2070) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, createDate, machineTool, isSynch, db9Db120, db9Db160, db9Dbx3705, db9Dbx3706);
    }
}
